...
public class HistoryFragment extends Fragment implements NumberPicker.OnValueChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentMonthSelected = view.findViewById(R.id.currentMonthSelected);
        mShortMonths = new DateFormatSymbols().getMonths();

        // month
        mMonthSpinner = view.findViewById(R.id.NumberPickerMonth);
        ...
        mYearSpinner = view.findViewById(R.id.NumberPickerYear);
